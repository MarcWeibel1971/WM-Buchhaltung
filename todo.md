...
## Audit-Umsetzung (aktuell)
- [x] Audit-Dokument prüfen, offene Feststellungen gegen den Codebestand abgleichen und als priorisierte Umsetzungsaufgaben erfassen
- [x] Audit P0.1: vat.detail durch orgProcedure absichern und Organisationsfilter serverseitig erzwingen
- [x] Audit P0.2: Revert von genehmigten Journaleinträgen serverseitig sperren; geführtes Storno bleibt als separater Ablauf vorgesehen
- [x] Audit P0.3: Buchungen in geschlossene Geschäftsjahre serverseitig verweigern und Geschäftsjahr aus dem Buchungsdatum ableiten
- [x] Audit P0.4: PDF-Analyse-Laufzeitabhängigkeit poppler-utils im Produktions-Image bereitstellen
- [x] Audit P0.5: CI enthält bereits pnpm check, pnpm test und pnpm build
- [x] Audit P0.6: Lohn, Zeiterfassung, Mahnwesen, Kreditoren, Jahresabschluss und Journal in der Navigation erreichbar machen
- [x] Audit P0.7: Deep-Links für Bankimport und Freigaben/Journal reparieren
- [x] Audit P0.8: Dokument-Transaktions-Matching mit Mindestscore 50, Mehrsignal-Regel und Vorzeichenprüfung härten

## Audit-Umsetzung P1
- [x] Audit P1.1: Debitoren-Zahlungsabgleich über QR-Referenz aus CAMT implementieren, Rechnung als bezahlt markieren und Buchungsvorschlag 1020/1100 erstellen
- [x] Audit P1.2: Keine EBICS-/POS-Secrets oder Zugangsdatenfelder im aktuellen Schema und Anwendungscode gespeichert; AES-Migration ist daher nicht anwendbar und bleibt bei einer späteren EBICS-/POS-Integration zwingend vorzusehen
- [x] Audit P1.3: Vier-Augen-Freigabe als Organisations-Einstellung ergänzt und bookDirect sowie Journal-Freigabe daran gebunden
- [x] Bugfix P1.1: CAMT-Quellreferenz auf die Datenbanklänge von 100 Zeichen begrenzen, ohne die Idempotenz aufzugeben
- [x] Audit P1.4: Geführten Stornoablauf für genehmigte Journaleinträge mit Gegenbuchung ergänzt
- [x] Audit P1.5: EUR-Buchungen bis zur vollständigen Kurs- und Umrechnungslogik serverseitig blockieren
- [x] Audit P1.6: Unreferenzierte Komponenten-Demoseite und Altseiten-Imports entfernt; QR-Referenzgenerierung zentralisiert; aktive Routen-Wrapper und der genutzte Rechnungseditor bewusst beibehalten
- [x] Audit P1.7a: Mahn-Policy als persistierte Organisations-Einstellung mit Owner/Admin-geschütztem Update-Endpunkt verwaltbar machen
- [x] Audit P1.7b: AHV-Fallback in der Lohnverarbeitung sichtbar warnen
- [x] Audit P1.7c: Manuell eingegebene QR-Referenzen vor dem Speichern auf die Modulo-10-Prüfziffer validieren
- [x] Audit P1.8: Daten-Reset mit expliziter Nicht-Produktionsfreigabe absichern; Root-Dateien auf Secrets prüfen und keine vertraulichen Dateien feststellen
- [ ] Audit P1.9: xlsx durch ExcelJS ersetzen sowie Dependabot und Main-Branch-Schutz vorbereiten
- [x] Audit P1.9a: xlsx durch ExcelJS ersetzen und Dependabot-Konfiguration ergänzen
- [ ] Audit P1.9b: Main-Branch-Protection am später verknüpften GitHub-Repository konfigurieren (Projekt hat derzeit nur ein internes Remote)
- [x] Audit P1.10: Produktionsrelevante Server- und Seed-Logging-Pfade von console.log auf strukturiertes Pino-Logging mit Request-Kontext migrieren
- [x] Audit P2.1: Zentralen routers.ts schrittweise in fachliche Router für VAT, Journal, Bank, Dokumente und Matching modularisieren
- [x] Audit P2.1a: Statische Sicherheits- und Unveränderlichkeitstests bei der Routerauslagerung auf die jeweiligen Fachmodule umstellen
- [x] Audit P2.1b: Doppelte Rechnungs- und QR-Formatierungshelfer in ein gemeinsames, eigenständig getestetes Servermodul überführen
- [x] Audit P2.1c: Bankimport-Snapshot-Typen aus dem zentralen Router in ein Fachmodul auslagern
- [x] Audit P2.1d: Kompakten Konten-Router vollständig in ein eigenes Fachmodul auslagern
- [x] Audit P2.1e: Kompakten Berichte-Router vollständig in ein eigenes Fachmodul auslagern
- [x] Audit P2.1f: Kompakten Avatar-Einstellungsrouter vollständig in ein eigenes Fachmodul auslagern
- [x] Audit P2.1g: Kompakten Import-Automatisierungsrouter vollständig in ein eigenes Fachmodul auslagern
- [x] Audit P2.1h: UID-Suchrouter vollständig in ein eigenes Fachmodul auslagern
- [x] Audit P2.1i: MWST-Router vollständig in ein eigenes Fachmodul auslagern und die statische Zugriffssicherheitsprüfung umstellen
- [x] Audit P2.1j: Journal-Router vollständig in ein eigenes Fachmodul auslagern und die GeBüV-Unveränderlichkeitsprüfung migrieren
- [x] Audit P2.1j-a: Wiederverwendbare Journal-Zod-Schemas in ein eigenes Fachmodul auslagern
- [x] Audit P2.1j-b: Gemeinsame Journal-Export-Eingabeschemas in ein eigenes Fachmodul auslagern
- [x] Audit P2.1j-b: Gemeinsame Journal-Export-Eingabeschemas in ein eigenes Fachmodul auslagern
- [x] Audit P2.1j-c: Journal-Listen- und ID-Abfrage-Eingabeschemas in ein eigenes Fachmodul auslagern
- [x] Audit P2.1j-c: Journal-Listen- und ID-Abfrage-Eingabeschemas in ein eigenes Fachmodul auslagern
- [x] Audit P2.1j-d: Journal-Sammelaktions-Eingabeschemas in ein eigenes Fachmodul auslagern
- [x] Audit P2.1j-d: Journal-Sammelaktions-Eingabeschemas in ein eigenes Fachmodul auslagern
- [x] Audit P2.1j-e: Journal-Erstell-, Änderungs- und Storno-Eingabeschemas in ein eigenes Fachmodul auslagern
- [x] Audit P2.1j-e: Journal-Erstell-, Änderungs- und Storno-Eingabeschemas in ein eigenes Fachmodul auslagern
- [x] Audit P2.1j-f: Journal-ID-Filter-Eingabeschema in ein eigenes Fachmodul auslagern
- [x] Audit P2.1j-f: Journal-ID-Filter-Eingabeschema in ein eigenes Fachmodul auslagern
- [x] Audit P2.1j-g: Standard-CSV-Export des Journalbereichs in ein eigenes Fachmodul auslagern
- [x] Audit P2.1j-g: Standard-CSV-Export des Journalbereichs in ein eigenes Fachmodul auslagern
- [x] Audit P2.1j-h: Organisationsspezifische GeBüV-Prüfung für Journal-Änderungen und -Löschungen in ein eigenes Guard-Modul auslagern
- [x] Audit P2.1j-i: Journal-Sammelgenehmigung und -löschung organisationsspezifisch absichern
- [x] Audit P2.1j-j: Journal-Listen-, Detail- und ID-Abfrageprozeduren in ein Fachmodul auslagern
- [x] Audit P2.1j-k: Journal-Erstell-, Genehmigungs- und Ablehnungsprozeduren in ein Fachmodul auslagern
- [x] Audit P2.1j-l: Journal-Änderungs-, Lösch- und Stornoprozeduren in ein Fachmodul auslagern
- [x] Audit P2.1j-m: Journal-Sammelaktionen in ein Fachmodul auslagern
- [x] Audit P2.1j-n: Journal-Exportprozeduren in ein Fachmodul auslagern
- [x] Audit P2.1j-n1: Standard-CSV-Exportprozedur in ein Fachmodul auslagern
- [x] Audit P2.1j-n2: Infoniqa-Exportprozedur in ein Fachmodul auslagern
- [x] Audit P2.1j-p: Nicht mehr verwendete Inline-Infoniqa-Exportimplementierung aus routers.ts entfernen
- [x] Audit P2.1k: Bankimport-Konto- und Transaktionslistenprozeduren in ein Fachmodul auslagern
- [x] Audit P2.1l: Bankimport-Undo-Snapshot-Prozeduren in ein Fachmodul auslagern
- [x] Audit P2.1m: Bankimport-Rollback- und IBAN-Validierungsprozeduren in ein Fachmodul auslagern
- [x] Audit P2.1n: Bankimport-Import- und automatisches Dokument-Matching in ein Fachmodul auslagern
- [x] Audit P2.1n-a: Bankimport-Historienabfragen organisationssicher in ein Fachmodul auslagern
- [x] Audit P2.1n-b: Bankimport-Importprozedur organisationssicher in ein Fachmodul auslagern
- [x] Audit P2.1o: KI-Kategorisierungsprozedur im Bankimport in ein Fachmodul auslagern
- [x] Audit P2.1p: Bankimport-Buchungs- und Statusänderungsprozeduren in Fachmodule auslagern
- [x] Audit P2.1p-a: Bankimport-Einzel- und Sammelbuchung organisationssicher in ein Fachmodul auslagern
- [x] Audit P2.1p-b: Bankimport-Ignorier-, Rücksetz- und Änderungsprozeduren in ein Fachmodul auslagern
- [x] Audit P2.1p-c: Bankimport-Sammelbuchung im aktiven Fachrouter bereitstellen
- [x] Audit P2.1q: KI-Buchungstext-Erzeugung im Bankimport in ein Fachmodul auslagern
- [x] Audit P2.1r: Bankimport-Regelaktualisierung in ein Fachmodul auslagern
- [x] Audit P2.1s: Bankimport-Transfererkennung in ein Fachmodul auslagern
- [x] Audit P2.1t: Bankimport-Regel- und Dokumentlisten in ein Fachmodul auslagern
- [x] Audit P2.1u: Bankimport-Transferfreigabe in ein Fachmodul auslagern
- [x] Audit P2.1v: Aktiven Bankimport-Router in ein eigenes Fachmodul zusammenführen
- [x] Audit P0-Folge: Bankimport-Transfererkennung und -freigabe organisationsspezifisch begrenzen
- [x] Audit P0-Folge: Bankimport-Regelaktualisierung organisationsspezifisch begrenzen
- [x] Audit P0-Folge: Eingebettete Bankimport-Buchungs-, Rücksetz-, Änderungs- und Sammelpfade organisationsspezifisch begrenzen
- [x] Audit P2.1j-o: Gesperrte Journal-Einzelrücksetzung in ein Fachmodul auslagern
- [x] Audit P0-Folge: Journal-Export- und ID-Abfragen organisationsspezifisch begrenzen
- [x] Audit P0-Folge: Journal-Einzelgenehmigung und -ablehnung organisationsspezifisch begrenzen
- [x] Audit P2.2: Settings.tsx und BankImport.tsx schrittweise in fokussierte Komponenten zerlegen
- [x] Audit P2.2a: Einstellungen-Navigation als eigenständige, typsichere Komponente auslagern
- [x] Audit P2.2b: Bankimport-Prozessstatus als eigenständige Komponente auslagern
- [x] Audit P2.2c: Bankimport-Geschäftsjahrswarnung und -auswahl in eigenständige Komponenten auslagern
- [x] Audit P2.2d: Bankimport-Betragsformatierung als gemeinsame Client-Hilfsfunktion auslagern
- [x] Audit P2.2e: Kontenplanimport der Settings-Seite in eine eigene Komponente auslagern
- [x] Audit P2.2f: Bankimport-Filter- und Aktionsleiste in eine eigene Komponente auslagern
- [x] Audit P2.2g: Eröffnungssalden-Importdialog der Settings-Seite in eine eigene Komponente auslagern
- [x] Audit P2.2l: Firmenlogo-Upload aus der Settings-Seite in eine fokussierte Fachkomponente auslagern
- [x] Audit P2.2m: Vier-Augen-Freigabe des Unternehmens-Tabs in eine fokussierte Fachkomponente auslagern
- [x] Audit P2.2o: Kontaktfelder des Unternehmens-Tabs in eine Fachkomponente auslagern
- [x] Audit P2.2p: Adressfelder des Unternehmens-Tabs in eine Fachkomponente auslagern
- [x] Audit P2.2q: Unternehmensstammdatenfelder des Unternehmens-Tabs in eine Fachkomponente auslagern
- [x] Audit P2.2r: MWST- und Geschäftsjahrsfelder des Unternehmens-Tabs in eine Fachkomponente auslagern
- [x] Audit P2.2s: Dokumentvorschau-Dialog des Bankimports in eine Fachkomponente auslagern
- [x] Audit P2.2t: Löschbestätigungsdialog des Bankimports in eine Fachkomponente auslagern
- [x] Audit P2.2u: Kreditkarten-Verarbeitungsdialog des Bankimports in eine Fachkomponente auslagern
- [x] Audit P2.2v: Transaktionsbearbeitungsdialog des Bankimports in eine Fachkomponente auslagern
- [x] Audit P2.2v-a: Dialoghülle des Transaktionsbearbeitungsdialogs in eine Fachkomponente auslagern
- [x] Audit P2.2v-b: Einzelbuchungsfelder des Transaktionseditors in eine Fachkomponente auslagern
- [x] Audit P2.2v-c: Sammelbuchungszeilen des Transaktionseditors in eine Fachkomponente auslagern
- [x] Audit P2.2v-d: Sammelbuchungs-Vorschau des Transaktionseditors in eine Fachkomponente auslagern
- [x] Audit P2.2v-e: Gematchte-Beleg-Information des Transaktionseditors in eine Fachkomponente auslagern
- [x] Audit P2.2v-f: KI-Begründungsabschnitt des Transaktionseditors in eine Fachkomponente auslagern
- [x] Audit P2.2v-g: Grunddatenabschnitt des Transaktionseditors in eine Fachkomponente auslagern
- [x] Audit P2.2v-h: Buchungsmodus-Umschalter des Transaktionseditors in eine Fachkomponente auslagern
- [x] Audit P2.2v-i: Festen Bankkontoabschnitt der Sammelbuchung in eine Fachkomponente auslagern
- [x] Audit P2.2v-j: Aktionsleiste des Transaktionseditors in eine Fachkomponente auslagern
- [x] Audit P2.2n: Sortieranzeige der Bankimport-Tabelle in eine fokussierte Fachkomponente auslagern
- [x] Audit P2.2h: Den vollständigen Kunden-Tab als aktive Fachkomponente zusammenführen und einmalig vollständig validieren
- [x] Audit P2.2h-a: Kunden-CSV- und Excel-Importdialog in eine Fachkomponente auslagern
- [x] Audit P2.2h-b: Kunden-Stammdatendialog in eine Fachkomponente auslagern
- [x] Audit P2.2h-c: Kunden-Dienstleistungsdialog in eine Fachkomponente auslagern
- [x] Audit P2.2h-d: Kundenliste in eine Fachkomponente auslagern
- [x] Audit P2.2h-e: Kunden-Filter- und Aktionsleiste in eine Fachkomponente auslagern
- [x] Audit P2.2h-f: Verbliebene Kunden-Tab-Steuerlogik in eine eigene Fachkomponente überführen
- [x] Nächster Arbeitsblock P2.2h-f: Kundenimport-Aufbereitung und Formularsteuerung aus Settings.tsx schrittweise in Fachmodule überführen
- [x] Audit P2.2h-f-a: Kundenimport-Aufbereitung als aktive Parser-Fachlogik aus Settings.tsx auslagern
- [x] Audit P2.2h-f-b: Kundenformular-Speicher- und Zurücksetzsteuerung in eine eigene Fachlogik überführen
- [x] Audit P2.2h-f-b: Kundenformular-Speicher- und Zurücksetzsteuerung in eine eigene Fachlogik überführen
- [x] Audit P2.2h-f-c: Kundenformular-Vorbelegung und Zurücksetzwerte in eine eigene Fachlogik überführen
- [x] Audit P2.2h-f-c: Kundenformular-Vorbelegung und Zurücksetzwerte in eine eigene Fachlogik überführen
- [x] Audit P2.2h-f-d: Dienstleistungsformular-Steuerung im Kunden-Tab in eine eigene Fachlogik überführen
- [x] Audit P2.2h-f-d: Dienstleistungsformular-Steuerung im Kunden-Tab in eine eigene Fachlogik überführen
- [x] Audit P2.2h-f-e: Kunden- und Dienstleistungsdialog-Ablaufsteuerung im Kunden-Tab weiter reduzieren
- [x] Audit P2.2h-f-e: Kunden- und Dienstleistungsdialog-Ablaufsteuerung im Kunden-Tab weiter reduzieren
- [x] Nächster Schritt P2.2h-f-e: Erfolgs- und Schliessabläufe der Kunden- und Dienstleistungsdialoge vereinheitlichen
- [x] Abnahmekriterium P2.2h-f-e: Erfolgsbenachrichtigung, Listenaktualisierung, Dialogschluss und Formular-Reset bleiben identisch
- [x] Aktive Umsetzung P2.2h-f-e: Gemeinsame Dialogabschluss-Hilfsabläufe im Kunden-Tab extrahieren
- [x] Abnahmekriterium P2.2h-f-b: Zurücksetzen, Bearbeiten und Speichern erzeugen weiterhin dieselben Kundenwerte und Mutationsaufrufe
- [x] Aktive Umsetzung P2.2h-f-b: Reine Kundenformular-Datenaufbereitung aus Settings.tsx in ein Fachmodul verschieben
- [x] Audit P2.2i: Lieferanten-CSV- und Excel-Importdialog in eine Fachkomponente auslagern
- [x] Audit P2.2j: Lieferanten-Stammdatendialog in eine Fachkomponente auslagern
- [x] Audit P2.2k: Lieferanten-Tab als aktive Fachkomponente zusammenführen und dessen Steuerlogik schrittweise reduzieren
- [x] Audit P2.2k-a: Ergebnisbereich des Lieferanten-Rechnungsimports in eine Fachkomponente auslagern
- [x] Audit P2.2k-b: Filter- und Aktionsleiste des Lieferanten-Tabs in eine Fachkomponente auslagern
- [x] Audit P2.2k-c: Tabellenansicht des Lieferanten-Tabs in eine Fachkomponente auslagern
- [x] Audit P2.2k-d: Formularinhalte des Lieferanten-Stammdatendialogs in eine Fachkomponente überführen
- [x] Audit P2.2k-d-a: Name und Kontaktperson des Lieferantenformulars in eine Fachkomponente auslagern
- [x] Audit P2.2k-d-b: Strassenfeld des Lieferantenformulars in dieselbe Fachkomponente auslagern
- [x] Audit P2.2k-d-c: PLZ-, Orts- und Länderfelder des Lieferantenformulars in dieselbe Fachkomponente auslagern
- [x] Audit P2.2k-d-c: PLZ-, Orts- und Länderfelder des Lieferantenformulars in dieselbe Fachkomponente auslagern
- [x] Audit P2.2k-d-d: Bank- und Kommunikationsfelder des Lieferantenformulars in dieselbe Fachkomponente auslagern
- [x] Audit P2.2k-d-d: Bank- und Kommunikationsfelder des Lieferantenformulars in dieselbe Fachkomponente auslagern
- [x] Audit P2.2k-d-e: Zahlungsfrist, Aufwandkonto, Match-Pattern und Notizen des Lieferantenformulars in dieselbe Fachkomponente auslagern
- [x] Audit P2.3: any-Verwendungen in Geldpfaden analysieren und LLM-Ausgaben mit Zod-DTOs absichern
- [x] Audit P2.3a: Bankimport-KI-Buchungsvorschläge mit einem begrenzten Zod-DTO validieren
- [x] Audit P2.3b: Weitere geldrelevante Fremd- und KI-Ausgaben auf unpräzise Typen prüfen und gegebenenfalls mit DTOs absichern
- [x] Audit P2.3b: Weitere geldrelevante Fremd- und KI-Ausgaben auf unpräzise Typen prüfen und gegebenenfalls mit DTOs absichern
- [x] Audit P2.4: Client-Kernflüsse mit Regressionstests absichern und Coverage-Gate in der CI ergänzen
- [x] Audit P2.4a: Lokalen Vitest-Coverage-Lauf und CI-Artefakt für Abdeckungsberichte ergänzen
- [x] Audit P2.4b: Kernflüsse für Login, Matching und QR-Rechnung mit gezielten Regressionstests ergänzen
- [x] Audit P2.4: Client-Kernflüsse mit Regressionstests absichern und Coverage-Gate in der CI ergänzen
- [ ] Audit P2.5: ESTV-konformen MWST-Export als CSV/XML-Fachfunktion bereitstellen
- [x] Technischer Teil P2.5: Organisationssicheren ESTV-Vorbereitungs-CSV-Export mit UI-Download bereitgestellt
- [x] Audit P2.5a: eCH-0217-Standard und ESTV-Uploadvorgaben für den MWST-Export fachlich prüfen
- [x] Audit P2.5b: MWST-Abrechnungswerte als organisationssichere ESTV-Vorbereitungs-CSV bereitstellen
- [x] Audit P2.5c: Vollständig schema-validen eCH-0217-XML-Export für die unterstützten Abrechnungsmethoden implementieren
- [x] Audit P2.5c-h: Reproduzierbaren Validierungslauf für alle eCH-0217-Periodenfixtures bereitstellen
- [x] Audit P2.5c-d: Repräsentativen XML-Entwurf der effektiven Methode gegen die offizielle eCH-0217:2025-XSD-Importkette erfolgreich validiert
- [x] Audit P2.5c-e: XML-Erzeugung für weitere unterstützte Abrechnungsmethoden und reale Periodendaten gegen den XSD-Satz validieren
- [x] Validierung P2.5c-e: Effektive Methode sowie Saldo- und Pauschalsteuersatzmethode mit repräsentativen Periodenfixtures gegen die offizielle XSD-Importkette validiert
- [x] Audit P2.5c-g: Pauschalsteuersatzmethode mit eigenem bewilligten organisationsspezifischen Satz modellieren und gegen XSD validieren
- [x] Audit P2.5c-g-a: Bewilligten Pauschalsteuersatz und Tätigkeit im Unternehmensformular erfassen und speichern
- [x] Umsetzung P2.5c-g: XML-Fachfunktion für Pauschalsteuersatz, Tätigkeit und Bruttoumsatz erzeugen
- [x] Umsetzung P2.5c-g: Bewilligte Tätigkeitsbezeichnung für die Pauschalsteuersatzmethode organisationssicher speichern
- [x] Umsetzung P2.5c-g: Eigenen Pauschalsteuersatz organisationssicher im Unternehmensdatenmodell speichern
- [x] Umsetzung P2.5c-g: Eigenen Pauschalsteuersatz organisationssicher im Unternehmensdatenmodell speichern
- [x] Vorbereitung P2.5c-e: Struktur der Saldosteuersatzmethode aus eCH-0217:2025 für eine XSD-validierte XML-Erzeugung abbilden
- [x] Vorbereitung P2.5c-e: Struktur der Saldosteuersatzmethode aus eCH-0217:2025 für eine XSD-validierte XML-Erzeugung abbilden
- [x] Validierung P2.5c-e: Saldosteuersatzmethode mit repräsentativem bewilligungspflichtigem Satz gegen den XSD-Satz validieren
- [x] Validierung P2.5c-e: Saldosteuersatzmethode mit repräsentativem bewilligungspflichtigem Satz gegen den XSD-Satz validieren
- [x] Audit P2.5c-f: Gespeicherten organisationsspezifischen Saldosteuersatz im XML-Entwurf verwenden
- [x] Regression P2.5c-f: Saldosteuersatz und UI-Freigabe des XML-Entwurfs gezielt absichern
- [x] Validierung P2.5c-e: Effektive Methode mit allen drei Steuersätzen gegen den XSD-Satz validieren
- [x] Validierung P2.5c-e: Effektive Methode mit allen drei Steuersätzen gegen den XSD-Satz validieren
- [x] Audit P2.5c-a: Nicht produktiven XML-Entwurf für die effektive Methode gegen die publizierte Datenstruktur generieren
- [x] Audit P2.5c-a: Nicht produktiven XML-Entwurf für die effektive Methode gegen die publizierte Datenstruktur generieren
- [x] Audit P2.5c-b: XML-Entwurf organisationssicher als klar nicht produktiven MWST-Export bereitstellen
- [x] Audit P2.5c-c: Nicht produktiven XML-Entwurf mit XSD-Warnung als separaten MWST-Download bereitstellen
- [x] Nächster technischer Arbeitsblock: eCH-0217:2025-XSD und referenzierte Standards in eine lokal prüfbare Validierungsbasis überführen
- [x] Vorbedingung P2.5c: Aktuelles eCH-0217:2025-Schema samt referenzierten XSDs vor der XML-Erzeugung als verbindliche Validierungsbasis integrieren
- [x] Externe Vorbedingung P2.5c: Vollständige maschinenlesbare XSD-Dateien von eCH-0217:2025 und ihren Referenzen beschaffen
- [x] Recherche P2.5c: Direkte und erste rekursive offizielle XSD-Importkette technisch verifiziert
- [x] Recherche P2.5c: Zweite Ebene der offiziellen XSD-Importkette technisch verifiziert
- [x] Recherche P2.5c: Sichtbare offizielle XSD-Importkette bis zum Blattknoten vollständig geprüft
- [x] Vorbereitung P2.5c: Offizielle XSD-Quellen als reproduzierbarer lokaler Schemaquellenkatalog hinterlegt
- [x] Vorbereitung P2.5c: Offizielle XSD-Importkette mit reproduzierbarem Abrufwerkzeug lokal ablegen und vollständig abrufen
- [x] Vorbereitung P2.5c: Offizielle XSD-Importkette mit reproduzierbarem Abrufwerkzeug lokal ablegen und vollständig abrufen
- [x] Vorbereitung P2.5c: Standardbibliotheksbasierte XSD-Validierungshilfe gegen die lokale Schemaablage ausführen
- [x] Prüfung P2.5c: Alternative eCH-XSD-Quelle versionsgenau gegen eCH-0217:2025 und Referenznormen validieren
- [x] Prüfung P2.5c: Alternative eCH-XSD-Quelle enthält keine eCH-0217-Datei und ist für den XML-Export ungeeignet
- [x] Audit P2.6: GeBüV-Archivexport für Journal, Belege und Kontoblätter pro Geschäftsjahr bereitstellen
- [x] Audit P2.6a: GeBüV-Grundlagen für Archivexport und rechtliche Abgrenzung fachlich dokumentieren
- [x] Audit P2.6b: Organisationssicheren Archivmanifest für genehmigtes Journal und Belegverzeichnis bereitstellen
- [x] Audit P2.6c: GeBüV-Archivmanifest im Journalexportdialog als Download bereitstellen
- [x] Audit P2.6d: Kontenblattauszüge als referenzierte Archivbestandteile im GeBüV-Manifest abbilden
- [x] Audit P2.6d: Kontenblattauszüge als referenzierte Archivbestandteile im GeBüV-Manifest abbilden
- [x] Audit P2.7: Offene-Posten-Listen für Debitoren und Kreditoren sowie Kontenblattexporte bereitstellen
- [x] Audit P2.7a: Debitoren-Offene-Posten-CSV mit Restbetrag und Überfälligkeit bereitstellen
- [x] Audit P2.7b: Debitoren-Offene-Posten-CSV im Mahnwesen als Downloadaktion bereitstellen
- [x] Audit P2.7c: Kreditoren-Offene-Posten und Kontenblatt-Auszug auf vorhandene Datenmodelle abbilden und exportierbar machen
- [x] Audit P2.7c-a: Kreditoren-Offene-Posten-CSV aus der bestehenden Zahlungserkennung bereitstellen
- [ ] Audit P2.8: Wiederkehrende Rechnungen und E-Mail-Beleg-Postfach fachlich vervollständigen
- [x] Technischer Teil P2.8: Wiederkehrende Rechnungsvorlagen einschließlich Heartbeat-Planung bereitgestellt
- [x] Analyse P2.8d: Verfügbare Outlook-Mail-Integration und ihre Laufzeitgrenzen für das Beleg-Postfach geprüft
- [ ] Externe Vorbedingung P2.8d: Serverseitige Microsoft-Graph- oder WebHook-Integration für ein dauerhaftes Beleg-Postfach freigeben
- [x] Audit P2.8a: Wiederkehrende Rechnungsvorlagen mit Fälligkeit, Status und Cron-Aufgaben-ID modellieren
- [x] Audit P2.8a: Wiederkehrende Rechnungsvorlagen mit Fälligkeit, Status und Cron-Aufgaben-ID modellieren
- [x] Audit P2.8b: Bedienoberfläche für wiederkehrende Rechnungsvorlagen im Rechnungsmodul bereitstellen
- [x] Audit P2.8b: Bedienoberfläche für wiederkehrende Rechnungsvorlagen im Rechnungsmodul bereitstellen
- [x] Audit P2.8b-a: Erfassungsdialog für wiederkehrende Rechnungsvorlagen im Rechnungsmodul bereitstellen
- [x] Audit P2.8c: Fällige wiederkehrende Rechnungsvorlagen idempotent verarbeiten und den nächsten Termin fortschreiben
- [x] Audit P2.8c: Fällige wiederkehrende Rechnungsvorlagen idempotent verarbeiten und den nächsten Termin fortschreiben
- [x] Audit P2.8c-a: Manuelle Ausführung fälliger wiederkehrender Vorlagen im Rechnungsmodul bereitstellen
- [x] Audit P2.8e: Heartbeat-Handler und verwaltete Zeitplanung für wiederkehrende Rechnungsvorlagen produktiv einbinden
- [x] Audit P2.8e: Heartbeat-Handler und verwaltete Zeitplanung für wiederkehrende Rechnungsvorlagen produktiv einbinden
- [x] Audit P2.8e-a: Cron-authentifizierten Handler für eine aufgabenbezogene Rechnungsvorlage bereitstellen
- [x] Vorbereitung P2.8e: Heartbeat-Schnittstelle, Cron-Authentifizierung und persistierbare Aufgaben-ID im Projekt validiert
- [x] Umsetzung P2.8e: Fällige-Vorlagen-Verarbeitung aus dem tRPC-Router in eine für Cron und manuelle Ausführung gemeinsame Fachlogik extrahieren
- [x] Umsetzung P2.8e: Fällige-Vorlagen-Verarbeitung aus dem tRPC-Router in eine für Cron und manuelle Ausführung gemeinsame Fachlogik extrahieren
- [x] Typisierung P2.8e: Gemeinsame Vorlagenverarbeitung mit dem konkreten Drizzle-Datenbanktyp statt unpräziser DB-Typen implementieren
- [x] Typisierung P2.8e: Gemeinsame Vorlagenverarbeitung mit dem konkreten Drizzle-Datenbanktyp statt unpräziser DB-Typen implementieren
- [x] Handlerbedingung P2.8e: Cron-Aufruf über `taskUid` auf genau eine Vorlage begrenzen, damit parallele Zeitpläne keine fremden Vorlagen ausführen
- [x] Handlerbedingung P2.8e: Cron-Aufruf über `taskUid` auf genau eine Vorlage begrenzen, damit parallele Zeitpläne keine fremden Vorlagen ausführen
- [x] Datenvertrag P2.8e: `scheduleCronTaskUid` beim Erstellen, Aktualisieren und Löschen einer Vorlage konsistent verwalten
- [x] Datenvertrag P2.8e: `scheduleCronTaskUid` beim Erstellen, Aktualisieren und Löschen einer Vorlage konsistent verwalten
- [x] Umsetzung P2.8e: Für jede aktivierte Vorlage einen täglichen Heartbeat mit fälligkeitsgeprüfter Einzelverarbeitung verwalten
- [x] Umsetzung P2.8e: Für jede aktivierte Vorlage einen täglichen Heartbeat mit fälligkeitsgeprüfter Einzelverarbeitung verwalten
- [x] Umsetzung P2.8e: Beim Löschen einer Vorlage ihre Heartbeat-Aufgabe kontrolliert entfernen
- [x] Umsetzung P2.8e: Beim Löschen einer Vorlage ihre Heartbeat-Aufgabe kontrolliert entfernen
- [x] Vorbereitung P2.8e: Organisationskontext und tRPC-Anfragezugriff für eine spätere sichere Zeitplanverwaltung geprüft
- [ ] Freigabe P2.8e: Nach Bereitstellung des Cron-Handlers die produktive Heartbeat-Zeitplanung einmalig aktivieren und überwachen
- [ ] Nachtest P2.8e: Nach Anlegen einer aktiven Vorlage die erzeugte Heartbeat-Aufgabe und einmalige Fälligkeitsverarbeitung prüfen
- [x] Audit P2.9: Terminologie und URLs vereinheitlichen sowie veraltete Weiterleitungen abbauen
- [x] Audit P2.9a: Alte Einstellungs-URLs auf die kanonische Settings-Route umleiten
- [x] Audit P2.9a: Alte Einstellungs-URLs auf die kanonische Settings-Route umleiten
- [x] Audit P2.9b: Navigation auf kanonische Settings-Route ausrichten und Abschluss-Sammelpfad weiterleiten
- [x] Audit P2.9b: Navigation auf kanonische Settings-Route ausrichten und Abschluss-Sammelpfad weiterleiten
- [ ] Audit P2.10: Index-Review, gezielte Lastprüfung und dokumentierten Wiederherstellungsablauf durchführen
- [x] Technischer Teil P2.10: Journalindex, Ausführungsplanprüfung und sicherer Restore-Drill-Ablauf dokumentiert
- [ ] Externe Restvoraussetzungen: XML-Schemasatz, Server-Mailbox, isoliertes Restore-/Staging-Umfeld und funktionierender Produktions-Login stehen noch aus
- [x] Dokumentation: Externe Auditvoraussetzungen zentral und nachtestorientiert zusammengefasst
- [x] Dokumentation: Technischen P2-Fortschritt und externe Restvoraussetzungen als Audit-Snapshot festgehalten
- [x] Laufende Umsetzung: Weitere externe-unabhängige Auditverbesserungen identifizieren und ohne Unterbrechung abarbeiten
- [ ] Audit-Fortsetzung: GitHub-Codebestand und Railway-Umgebung gegen die verbleibenden Auditpunkte abgleichen und unabhängige Umsetzungen fortsetzen
- [ ] GitHub-Abgleich: Den validierten Audit-Arbeitsstand auf einem separaten, nicht produktiv ausgerollten Zweig bereitstellen
- [x] Audit P2.10b: Den Ausführungsplan repräsentativer organisationsbezogener Journalabfragen gegen den neuen Index prüfen
- [x] Audit P2.10b: Den Ausführungsplan repräsentativer organisationsbezogener Journalabfragen gegen den neuen Index prüfen
- [ ] Audit P2.10c: Wiederherstellungsablauf mit isoliertem Sicherungsstand und dokumentierter Integritätsprüfung durchführen
- [ ] Nachtest P2.10b: Den Journalindex mit einem anonymisierten Staging-Dataset unter repräsentativer Last messen
- [x] Umsetzung P2.8c: Fällige Vorlagen als Rechnungsentwürfe mit Position erzeugen und atomar zum Folgetermin fortschreiben
- [x] Umsetzung P2.8c: Terminfortschreibung der wiederkehrenden Rechnungsvorlagen kalendergenau und testbar kapseln
- [x] Umsetzung P2.8c: Terminfortschreibung der wiederkehrenden Rechnungsvorlagen kalendergenau und testbar kapseln
- [x] Audit P2.7d: Kontenblattauszug pro Konto und Geschäftsjahr als CSV bereitstellen
- [x] Audit P2.7d: Kontenblattauszug pro Konto und Geschäftsjahr als CSV bereitstellen
- [x] Umsetzung P2.7c: Kreditorenexport auf `qrBill.listUnpaidInvoices`-Zahlungserkennung und Dokumentmetadaten aufbauen
- [x] Recherche P2.5c: Aktuelle eCH-0217:2025-Version, Schemaanlage und Normabhängigkeiten verbindlich identifizieren
- [ ] Nachtest P2.5b: ESTV-CSV-Download nach Wiederherstellung des Testkontos im geschützten MWST-Bereich live verifizieren
- [ ] Nachtest P2.8b: Bedienoberfläche wiederkehrender Rechnungsvorlagen nach Wiederherstellung des Testkontos live verifizieren
- [ ] Autorisierter Produktionsnachtest: MWST-CSV und wiederkehrende Rechnungsvorlagen mit dem persönlichen Produktionszugang prüfen
- [ ] Externer Nachtestblocker: Persönliche Manus-OAuth-Anmeldung liefert CloudFront 403 und verhindert derzeit den Produktionsnachtest
- [x] Umsetzung P2.2k-d-e: Feldvertrag für Zahlungsfrist, Aufwandkonto, Match-Pattern und Notizen in SupplierFormFields ergänzen
- [x] Regression P2.2k-d-e: Die neue Zahlungs- und Zuordnungsgruppe in SupplierFormFields und Settings aktiv absichern
- [x] Validierung P2.2k-d-e: TypeScript und vollständige Vitest-Suite nach der aktiven Zahlungs- und Zuordnungsauslagerung ausführen
- [x] Aktive Umsetzung P2.2k-d-e: Zahlungs- und Zuordnungsgruppe im Lieferantenformular von Settings.tsx nach SupplierFormFields.tsx verschieben
- [x] Abschluss P2.2k-d-e: Die neue Fachkomponente aktiv einbinden und den bisherigen Inline-Block entfernen
- [x] Nächster Arbeitsblock: Den vollständigen Zahlungs- und Zuordnungsabschnitt gemeinsam auslagern, dann genau einmal vollständig validieren
- [x] Abnahmekriterium P2.2k-d-e: Zahlungsbedingungen, Aufwandkonto, Bankimport-Muster und Notizen bleiben mit den bestehenden Speicherwerten verbunden
- [x] Nächster Umsetzungsschritt: Lieferanten-Formularfelder mit unverändertem Speichervertrag als eigene Fachkomponente kapseln
- [x] Abnahmekriterium P2.2k-d: Alle zwölf Lieferantenfelder, die Aufwandkonto-Auswahl und die Match-Pattern-Hilfe werden durch die ausgelagerte Komponente gerendert
- [x] Regression P2.2k-d: Der Speicher- und Abbruchablauf des ausgelagerten Lieferantenformulars bleibt aktiv eingebunden
- [x] Basisabgleich: Tatsächlich geladenen Stand einmalig gegen die offenen Auditpunkte prüfen und genau einen nächsten Punkt festlegen
- [x] Nächster Einzelpunkt: Den vollständigen Journal-Router aus dem zentralen Router in server/journalRouter.ts überführen
- [x] Priorität: P2.2e vor P2.2f umsetzen und beide Schritte vollständig testen
- [x] Arbeitsmodus: Priorisierte Audit-Refactorings selbständig umsetzen; nur bei zwingenden externen Entscheidungen Rückfrage stellen
- [x] Blocker Live-Test: users-Tabelle im Entwicklungsdatenbank-Schema mit der Authentifizierungsabfrage synchronisieren
- [ ] Nachtest: CAMT-Debitorenabgleich nach erfolgreicher OAuth-Anmeldung visuell mit einem echten CAMT.054-Zahlungseingang prüfen
- [x] Automatisierte Grundlage: CAMT-Debitorenabgleich wird durch die bestehende Matching-Regression abgesichert
- [x] Blocker Deployment: Produktionsstart reparieren, da dist/index.js zur Laufzeit das nicht installierte Paket vite importiert

## GitHub-Merge-Konflikte
- [x] Konflikte in routers.ts, invoicesRouter.ts und posWebhook.ts so auflösen, dass Feature-Änderungen und strukturiertes Logging gemeinsam erhalten bleiben
- [x] Lokaler Befund: Im aktuellen Arbeitsbaum bestehen keine unaufgelösten Git-Merge-Konflikte
- [x] Lokaler Befund: Der im Audit erwähnte POS-Webhook ist im aktuellen Projektstand nicht vorhanden und daher nicht konfliktbehaftet
